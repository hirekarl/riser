...
- [x] Final accessibility pass: contrast, jsx-a11y, axe (Fri 7/24). Completed by Schiffon on Mon 7/27 (verbal sign-off given to Karl; whole-app VoiceOver screen reader, keyboard-only walkthrough, contrast/jsx-a11y/axe checks complete).
