---
name: new-sprint
description: Scaffold the next two-week sprint file under docs/sprints/ from TEMPLATE.md, auto-incrementing the sprint number and filling in the next two-week date range. Use when the user asks to start a new sprint or close out the current one.
---
...
2. Read the current highest sprint file's `**Dates:**` line to get its end date. The new sprint's start date is the day after that end date; its end date is start + 13 days (14-day/2-week window inclusive).
