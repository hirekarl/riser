...
describe("App", () => {
  ...
  it("wires the building form, elevator form, and ledger together end to end", async () => {
    ...
    // Scoped to the "Add a building" form: the address-lookup form shell
    // (AddressLookupForm) also has an "Address" labeled field elsewhere on
    // the page, so an unscoped getByLabelText(/address/i) is now ambiguous.
